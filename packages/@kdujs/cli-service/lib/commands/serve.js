...
module.exports = (api, options) => {
  api.registerCommand('serve', {
    ...
    return new Promise((resolve, reject) => {
      ...
      compiler.hooks.done.tap('kdu-cli-service serve', stats => {
        if (stats.hasErrors()) {
          return
        }
        ...
        if (!isInContainer) {
          ...
          console.log()
          console.log(chalk.yellow(`  It seems you are running Kdu CLI inside a container.`))
        ...
        } else if (process.env.KDU_CLI_TEST) {

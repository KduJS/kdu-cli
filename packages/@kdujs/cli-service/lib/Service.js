...
const { warn, error, isPlugin, resolvePluginId, loadModule, resolvePkg, resolveModule, sortPlugins } = require('@kdujs/cli-shared-utils')
...
module.exports = class Service {
  ...
  resolvePlugins (inlinePlugins, useBuiltIn) {
    ...
    debug('kdu:plugins')(plugins)

    const orderedPlugins = sortPlugins(plugins)
    debug('kdu:plugins-ordered')(orderedPlugins)
  ...
  resolveWebpackConfig (chainableConfig = this.resolveChainableWebpackConfig()) {
    ...
    if (
      !process.env.KDU_CLI_ENTRY_FILES &&

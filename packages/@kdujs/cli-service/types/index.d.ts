 ...
 * creating new kdu-cli service commands or changing existing commands
 *
 * @param api - A PluginAPI instance
 * @param options - An object containing project local options specified in kdu.config.js,
 *    or in the "kdu" field in package.json.
 */
type ServicePlugin = (
  api: PluginAPI,

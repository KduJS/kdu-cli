...
interface ProjectOptions {
   ...
   * Default: `'dist'`
   *
   * The directory where the production build files will be generated in when running `kdu-cli-service build`
   */
  outputDir?: string;
  /**
   * Default: `''`
   ...
   * Default: `false`
   *
   * Whether to use the build of Kdu core that includes the runtime compiler
   */
  ...
  /**
   * Pass options to the [PWA Plugin](https://github.com/kdujs/kdu-cli/tree/main/packages/%40kdujs/cli-plugin-pwa)
   */
  pwa?: object;

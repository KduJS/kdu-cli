...
const {
  ...
  hasProjectPnpm
} = require('@kdujs/cli-shared-utils/lib/env')
const { isOfficialPlugin, resolvePluginId } = require('@kdujs/cli-shared-utils/lib/pluginResolution')
const { log, warn } = require('@kdujs/cli-shared-utils/lib/logger')
...
class PackageManager {
  ...
  async upgrade (packageName) {
    ...
    if (
      isTestOrDebug &&
      (packageName === '@kdujs/cli-service' || isOfficialPlugin(resolvePluginId(realname)))
    ) {

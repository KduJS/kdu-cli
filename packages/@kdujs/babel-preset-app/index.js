...
module.exports = (context, options = {}) => {
  ...
  // Though in the kdu-cli repo, we only use the two envrionment variables
  ...
  if (options.jsx !== false) {
    presets.push([require('@kdujs/babel-preset-jsx'), typeof options.jsx === 'object' ? options.jsx : {}])
  }
  ...
  const {
    ...
    targets: rawTargets,
    spec,
    ignoreBrowserslistConfig = !!process.env.KDU_CLI_MODERN_BUILD,
    configPath,
    include,
    exclude,
    shippedProposals,
  ...
  if (
    ...
    !process.env.KDU_CLI_MODERN_BUILD
  ) {
  ...
  if (useBuiltIns === 'usage' && !process.env.KDU_CLI_MODERN_BUILD) {
